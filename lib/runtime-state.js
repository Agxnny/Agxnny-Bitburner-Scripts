...
// Port 2 stores the latest short-lived planner snapshot.
// Port 3 stores the latest short-lived tactical thread-plan snapshot.
// Writers replace the current value; consumers only peek, so these ports act as
// tiny shared-state slots rather than message queues.
